...
A cellular automaton simulation where cells live, die, or reproduce based on simple rules.
...
- 1: Load "block" pattern (stable)
- 2: Load "blinker" pattern (oscillator)
- 3: Load "glider" pattern (spaceship)
...
Usage:
    python conways_game_of_life_improved.py
"""
...
def adjust_grid(positions):
    ...
    # Check survival of existing cells
