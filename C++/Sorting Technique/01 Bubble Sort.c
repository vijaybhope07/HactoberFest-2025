...
// Bubble sort is Adptive: if the list is sorted it will use flag  // Bubble
// sort is stable  : in case of duplicate time complexity is : min = o(n) - in
// the case of Adaptivity
//					  : max = o(n2)