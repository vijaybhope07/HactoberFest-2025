...
creating a path-like exploration.
- The 'dfsUtil' function is a utility that performs the actual recursion for
exploring nodes.
- Similar to BFS, a 'visited' array is used to keep track of which nodes have
been visited, preventing cycles.
