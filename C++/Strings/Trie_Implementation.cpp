...
int main() {
    ...
    cout << "Search 'hello': "
         << (trie->search("hello") ? "Found" : "Not found") << endl;
    cout << "Search 'help': " << (trie->search("help") ? "Found" : "Not found")
         << endl;
    cout << "Search 'hel': " << (trie->search("hel") ? "Found" : "Not found")
         << endl;
    cout << "Starts with 'hel': " << (trie->startsWith("hel") ? "Yes" : "No")
         << endl;
    cout << "Search 'world': "
         << (trie->search("world") ? "Found" : "Not found") << endl;
