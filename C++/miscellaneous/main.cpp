...
class Linked_list {
   ...
   public:
    ...
    void display() {
        Node *temp = first;
        if (temp == NULL) cout << "No Data!" << endl;
        while (temp != NULL) {
            cout << "------------------------------" << endl;
    ...
    void findValue(int in) {
        ...
        if (in < h) {
            if (temp == NULL)
                ...
                cout << "The value at index:" << in << " is:" << temp->getData()
                     << endl;
            }
        }
    }
    void sameVal(int intgr) {
        Node *temp = first;
        int cont = 0;
        if (temp == NULL) cout << "NO DATA in LIST!" << endl;
...
int main() {
    ...
    do {
        ...
        cout << "If you want to close the program press 0 otherwise press 1!"
             << endl;
        cin >> s;
    } while (s != 0);
