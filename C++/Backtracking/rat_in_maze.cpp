...
maze[0][0] (left top corner) is the source and maze[N-1][N-1](right bottom
corner) is the destination. There are few cells which are blocked, i.e. rat
cannot enter into those cells. Rat can move in any direction ( left, right, up
and down).*/
